...
public class PuzzleErrors {
    ...
    public static String MISSING_PUZZLE_ELEMENTS = "Missing puzzle element with the ID: %s\n";
    public static String WRONG_ELEMENT_IDS = "Puzzle of size <%s> cannot have the following ID: %s\n";
